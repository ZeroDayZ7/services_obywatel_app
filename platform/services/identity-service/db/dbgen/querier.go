...
type Querier interface {
	...
	GetCitizenByEmailHash(ctx context.Context, emailHash string) (GetCitizenByEmailHashRow, error)
	GetCitizenByPeselHash(ctx context.Context, peselHash string) (GetCitizenByPeselHashRow, error)
	GetCitizenByPhoneHash(ctx context.Context, phoneHash string) (GetCitizenByPhoneHashRow, error)
