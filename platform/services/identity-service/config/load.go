...
// Load wczytuje konfigurację i zwraca nową instancję *Config.
func Load() (*Config, error) {
	...
	var cfg Config
	if err := viper.InitConfig(&cfg, "identity-service"); err != nil {
		return nil, fmt.Errorf("failed to initialize identity-service config: %w", err)
	}
