...
func (s *citizenService) RegisterCitizen(
	...
	// 2. Niezależne szyfrowanie numeru telefonu
	...
	// 3. Niezależne szyfrowanie adresu e-mail
	...
	// 4. Szyfrowanie pliku PDF umowy (Envelope Encryption)
	...
	// 5. Upload zaszyfrowanego PDF do MinIO / S3
	s3Bucket := "agreements"
	...
	// 6. Przygotowanie struktury UserAgreement
